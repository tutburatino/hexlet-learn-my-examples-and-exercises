...
import SimpleCard from '../../../src/data-driven-development/dispatch/simpleCard';
import PercentCard from '../../../src/data-driven-development/dispatch/percentCard';
import make from '../../../src/data-driven-development/dispatch/solution';


describe('CardGame', () => {
  it('#flow 1', () => {
    const cards = l(SimpleCard('Жесткий ломатель мироздания', 6));
  ...
  it('#flow 2', () => {
    let cardIndex = 1;
    const cards = l(
      SimpleCard('Ошарашивающие шорты равновесия', 7),
      PercentCard('Фаланговая знатность утешения', 80),
    );
